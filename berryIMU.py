...
# Kalman filter variables, used globally in the kalmanFilter methods
Q_angle = 0.02
Q_gyro = 0.0015
R_angle = 0.005
y_bias = 0.0
...
# will be used as global variables in kalmanFilter methods
gyroXangle = 0.0
gyroYangle = 0.0
gyroZangle = 0.0
CFangleX = 0.0
...
class CalculationClass(threading.Thread):

    def __init__(self):
        print("calc class init")
    ...
    def kalmanFilterY(self, accAngle, gyroRate, DT):
        ...
        # use variables defined outside of CalculationClass
        global KFangleY
        global Q_angle
        global Q_gyro
        global y_bias
    ...
    def runKalmanThread(self):
        ...
        while True:
            ...
            globalKalman.kalmanY = self.kalmanFilterY(AccYangle, rate_gyr_y, LP)
            globalKalman.kalmanX = self.kalmanFilterX(AccXangle, rate_gyr_x, LP)
            ...
            if 1:  # Change to '0' to stop  showing the angles from the Kalman filter
                print("# kalmanX %5.2f   kalmanY %5.2f #" % (globalKalman.kalmanX, globalKalman.kalmanY)),
